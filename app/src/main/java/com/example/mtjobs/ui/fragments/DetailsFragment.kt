...
class DetailsFragment : Fragment(R.layout.fragment_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val jobModel: JobsResponseItem = jobsViewModel.cashedJobs.value?.bodyData?.first {
            it.id == args.jobId
        }!!
        val favoriteItem = FavoriteItem(jobModel.id)
        ...
        binding.detailsIcFavorite.setOnClickListener {
            jobsViewModel.toggleIsFavorite(favoriteItem)
        }
